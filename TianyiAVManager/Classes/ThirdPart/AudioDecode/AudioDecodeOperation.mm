...
- (OSStatus)doConvert:(CFURLRef )sourceURL outPuturl:(CFURLRef )outPutURL outputFormat:(OSType )outputFormat outputSampleRate:(Float64)slr mChannelsPerFrame:(int)mChannels
{
    ...
    NSLog(@"AudioDecode-Debug: DoConvertFile");
    ...
    try {
        ...
        NSLog(@"AudioDecode-Debug: Source file format: "); srcFormat.Print();
        ...
        NSLog(@"AudioDecode-Debug: Destination file format: "); dstFormat.Print();
        ...
        NSLog(@"AudioDecode-Debug: Client data format: "); clientFormat.Print();
        ...
        if (noErr == error) {
            ...
            NSLog(@"AudioDecode-Debug: Audio Converter %s continue after interruption!\n", (canResumeFromInterruption == 0 ? "CANNOT" : "CAN"));
        } else {
            ...
            if (kAudioConverterErr_PropertyNotSupported == error) {
                NSLog(@"AudioDecode-Debug: kAudioConverterPropertyCanResumeFromInterruption property not supported!\n");
            } else {
                NSLog(@"AudioDecode-Debug: AudioConverterGetProperty kAudioConverterPropertyCanResumeFromInterruption result %ld\n", error);
            }
        ...
        NSLog(@"AudioDecode-Debug: Converting...\n");
        while (1) {
            ...
            if (error) {
                ...
                if (kExtAudioFileError_CodecUnavailableInputConsumed == error) {
                    ...
                    NSLog(@"AudioDecode-Debug: ExtAudioFileWrite kExtAudioFileError_CodecUnavailableInputConsumed error %ld\n", error);
                    ...
                    NSLog(@"AudioDecode-Debug: ExtAudioFileWrite kExtAudioFileError_CodecUnavailableInputNotConsumed error %ld\n", error);
